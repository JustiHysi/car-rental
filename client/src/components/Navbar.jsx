...
const Navbar = () => {
  return (
    <div className="flex justify-between w-full py-3 px-24 items-center border-b border-borderColor ">
      <img src={assets.logo} height={30} className="" />
      ...
      <div className="flex items-center gap-6">
        ...
        <NavLink className="text-grayColorText"  to={"/list"}>
            List cars
          </NavLink>

          <button className="bg-primary hover:bg-primary-dull text-white rounded-xl py-2 px-8">Sign up</button>
